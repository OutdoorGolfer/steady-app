    ...
    <div style={{minHeight:"100vh",padding:"32px 20px",maxWidth:480,margin:"0 auto"}}>
      ...
      {totalCheckins > 0 && (
        <div style={{display:"flex",gap:10,marginBottom:20}}>
          <div style={{flex:1,background:"#0F172A",border:"1px solid #1E293B",borderRadius:12,padding:"12px 14px",textAlign:"center"}}>
            <p style={{fontFamily:"'DM Sans', sans-serif",fontSize:11,color:"#64748B",margin:0,fontWeight:600,textTransform:"uppercase",letterSpacing:0.5}}>Streak</p>
            <p style={{fontFamily:"'Fraunces', serif",fontSize:22,color:streak>=3?"#4ADE80":"#6366F1",margin:"2px 0 0"}}>{streak} <span style={{fontSize:12,color:"#64748B"}}>day{streak!==1?"s":""}</span></p>
          </div>
          {savedAmount > 0 && (
            <div style={{flex:1,background:"#0F172A",border:"1px solid #1E293B",borderRadius:12,padding:"12px 14px",textAlign:"center"}}>
              <p style={{fontFamily:"'DM Sans', sans-serif",fontSize:11,color:"#64748B",margin:0,fontWeight:600,textTransform:"uppercase",letterSpacing:0.5}}>Saved</p>
              <p style={{fontFamily:"'Fraunces', serif",fontSize:22,color:"#4ADE80",margin:"2px 0 0"}}>${savedAmount.toLocaleString()}</p>
            </div>
          )}
          <div style={{flex:1,background:"#0F172A",border:"1px solid #1E293B",borderRadius:12,padding:"12px 14px",textAlign:"center"}}>
            <p style={{fontFamily:"'DM Sans', sans-serif",fontSize:11,color:"#64748B",margin:0,fontWeight:600,textTransform:"uppercase",letterSpacing:0.5}}>Check-ins</p>
            <p style={{fontFamily:"'Fraunces', serif",fontSize:22,color:"#6366F1",margin:"2px 0 0"}}>{totalCheckins}</p>
          </div>
        </div>
      )}
