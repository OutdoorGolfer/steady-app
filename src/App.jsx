...
const DECISION_TYPES = [
  { id: "commit", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="8.5" cy="7" r="4" /><line x1="20" y1="8" x2="20" y2="14" /><line x1="23" y1="11" x2="17" y2="11" /></svg>, label: "Saying 'Yes' to a new commitment" },
  { id: "quit", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><line x1="15" y1="9" x2="9" y2="15" /><line x1="9" y1="9" x2="15" y2="15" /></svg>, label: "Quitting or backing out of something" },
  { id: "message", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>, label: "Sending an emotional message" },
  { id: "life", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76" /></svg>, label: "A major life change (move, job, etc.)" },
  { id: "money", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></svg>, label: "A big financial move" },
];
  ...
  if (confirmSent) {
    return (
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "32px 24px" }}>
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 16 }}><rect x="2" y="4" width="20" height="16" rx="2" /><polyline points="22,7 12,13 2,7" /></svg>
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16, width: "100%", maxWidth: 360 }}>
        <button
          onClick={() => onComplete("full", { sleep: 3, energy: 3, stress: 3, impulse: 3 }, 12)}
          style={{
            display: "flex",
            alignItems: "center",
            gap: 16,
        ...
        >
          <svg width="36" height="36" viewBox="0 0 36 36" style={{ flexShrink: 0 }}><circle cx="18" cy="18" r="14" fill="#4ADE80" opacity="0.9" /><circle cx="18" cy="18" r="14" fill="none" stroke="#4ADE80" strokeWidth="1.5" /></svg>
          <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 20, color: "#4ADE80", fontWeight: 600 }}>I'm clear and rested</span>
        </button>

        <button
          onClick={() => onComplete("light", { sleep: 2, energy: 2, stress: 2, impulse: 2 }, 8)}
          style={{
            display: "flex",
            alignItems: "center",
            gap: 16,
        ...
        >
          <svg width="36" height="36" viewBox="0 0 36 36" style={{ flexShrink: 0 }}><circle cx="18" cy="18" r="14" fill="#FBBF24" opacity="0.9" /><circle cx="18" cy="18" r="14" fill="none" stroke="#FBBF24" strokeWidth="1.5" /></svg>
          <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 20, color: "#FBBF24", fontWeight: 600 }}>I'm a bit tired or distracted</span>
        </button>

        <button
          onClick={() => onComplete("survival", { sleep: 1, energy: 1, stress: 1, impulse: 1 }, 4)}
          style={{
            display: "flex",
            alignItems: "center",
            gap: 16,
        ...
        >
          <svg width="36" height="36" viewBox="0 0 36 36" style={{ flexShrink: 0 }}><circle cx="18" cy="18" r="14" fill="#F87171" opacity="0.9" /><circle cx="18" cy="18" r="14" fill="none" stroke="#F87171" strokeWidth="1.5" /></svg>
          <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 20, color: "#F87171", fontWeight: 600 }}>I'm overwhelmed or running on empty</span>
        </button>
      </div>
    </div>
  );
...
function TimerAlert({ item, onResolve, onSnooze }) {
  ...
  if (resolved) {
    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
        {skipped ? (
          <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#4ADE80" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 20 }}><path d="M12 3L4 7v5c0 5.25 3.4 10.15 8 11.5 4.6-1.35 8-6.25 8-11.5V7l-8-4z" /><polyline points="9 12 11 14 15 10" /></svg>
        ) : (
          <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#FBBF24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 20 }}><path d="M14 9V5a3 3 0 0 0-6 0v4" /><rect x="2" y="9" width="20" height="13" rx="2" /><circle cx="12" cy="16" r="1" /></svg>
        )}
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="#E2E8F0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 16 }}><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>
...
function Dashboard({ mode, setScreen, spendLog, pendingItems, readyItems, checkins, onLogout }) {
  const m = MODES[mode] || null;
  const uncalibrated = !m;
  ...
  return (
    <div style={{ minHeight: "100vh", padding: "30px 20px 24px", maxWidth: 480, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", paddingBottom: 12 }}>
        <button onClick={() => setScreen("settings")} style={{ background: "transparent", border: "none", opacity: 0.5, cursor: "pointer", padding: 4, display: "flex", alignItems: "center" }}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" /></svg></button>
      </div>
      ...
      {uncalibrated ? (
        ...
        >
          <h1 style={{ fontFamily: "’Fraunces’, serif", fontSize: 36, lineHeight: 1.2, fontWeight: 600, color: "#F1F5F9", margin: "0 0 12px" }}>
            Good morning.
          </h1>
          <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 17, color: "#94A3B8", margin: "0 0 20px", lineHeight: 1.5 }}>
            Take 30 seconds to calibrate your day so we know how to help.
          </p>
          <button
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 10 }}>
            <svg width="24" height="24" viewBox="0 0 24 24" style={{ flexShrink: 0 }}><circle cx="12" cy="12" r="10" fill={m.color} /></svg>
            <div>
          ...
          <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 17, color: "#D5DFEC", margin: "16px 0 0", lineHeight: 1.5 }}>
            {m.desc}
          </p>
        </section>
      )}
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: 10 }}>
        <button onClick={() => setScreen("spend")} style={{ ...primaryCardStyle, background: "#161E2E", border: "1px solid #312E81" }}>
          <div style={{ ...iconWrap, background: "rgba(251,191,36,0.08)" }}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FBBF24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2" /><line x1="2" y1="10" x2="22" y2="10" /><line x1="6" y1="14" x2="10" y2="14" /></svg>
          </div>
          <div style={{ flex: 1 }}>
            <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 18, fontWeight: 700, color: "#F8FAFC", margin: "0 0 6px" }}>
              Thinking about buying something?
            </p>
            <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 14, color: "#93A4BD", margin: 0, lineHeight: 1.45 }}>
              Wait before you spend. We’ll help you slow it down.
            </p>
          </div>
          <span style={{ color: "#51627D", fontSize: 22 }}>›</span>
        </button>

        <button onClick={() => setScreen("decision")} style={primaryCardStyle}>
          <div style={{ ...iconWrap, background: "rgba(74,222,128,0.08)" }}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#4ADE80" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3L4 7v5c0 5.25 3.4 10.15 8 11.5 4.6-1.35 8-6.25 8-11.5V7l-8-4z" /></svg>
          </div>
          <div style={{ flex: 1 }}>
            <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 18, fontWeight: 700, color: "#F8FAFC", margin: "0 0 6px" }}>
              About to make a big choice?
            </p>
            <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 14, color: "#93A4BD", margin: 0, lineHeight: 1.45 }}>
              Run it by us before you commit, quit, or send a message.
            </p>
          </div>
          <span style={{ color: "#51627D", fontSize: 22 }}>›</span>
        </button>
      ...
      {/* MONEY SAVED */}
      <section style={{ textAlign: "center", padding: "28px 20px", marginBottom: 18 }}>
        {savedAmount > 0 ? (
          <>
            <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 11, color: "#64748B", margin: "0 0 8px", fontWeight: 700, textTransform: "uppercase", letterSpacing: 4 }}>
              Money you kept
            </p>
            <p style={{ fontFamily: "’Fraunces’, serif", fontSize: 52, fontWeight: 700, color: "#4ADE80", margin: 0, textShadow: "0 0 32px rgba(74,222,128,0.35)" }}>
              ${savedAmount.toLocaleString()}
            </p>
          </>
        ) : (
          <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 15, color: "#64748B", margin: 0 }}>
            Ready to catch your first impulse.
          </p>
        )}
      </section>
      ...
      {pendingItems.length > 0 && (
        <section style={{ marginBottom: 18 }}>
          ...
          <div style={{ background: "#0F172A", borderRadius: 24, padding: "16px 16px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {pendingItems.map(item => {
                ...
                return (
                  <div key={item.id} style={{ background: "#020617", borderRadius: 18, padding: "16px 14px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12 }}>
                    <div>
      ...
      <section style={{ marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <button onClick={() => setScreen("track-record")} style={secondaryCard}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}><rect x="3" y="12" width="4" height="9" rx="1" /><rect x="10" y="7" width="4" height="14" rx="1" /><rect x="17" y="3" width="4" height="18" rx="1" /></svg>
            <div style={{ flex: 1 }}>
              <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 16, fontWeight: 700, color: "#F8FAFC", margin: 0 }}>Look at my track record</p>
              <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 13, color: "#94A3B8", margin: "4px 0 0" }}>
                See the money you’ve kept and your past choices
              </p>
            </div>
            <span style={{ color: "#51627D", fontSize: 20 }}>›</span>
          </button>

          <button onClick={() => setScreen("reset")} style={secondaryCard}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}><path d="M9.59 4.59A2 2 0 1 1 11 8H2" /><path d="M12.59 19.41A2 2 0 1 0 14 16H2" /><path d="M17.73 7.27A2.5 2.5 0 1 1 19.5 12H2" /></svg>
            <div style={{ flex: 1 }}>
              <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 16, fontWeight: 700, color: "#F8FAFC", margin: 0 }}>I need a quick reset</p>
              <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 13, color: "#94A3B8", margin: "4px 0 0" }}>
                Take 10 seconds to physically ground yourself
              </p>
            </div>
            <span style={{ color: "#51627D", fontSize: 20 }}>›</span>
          </button>
...
function DecisionGate({ mode, onBack, onLog }) {
  const [phase, setPhase] = useState("select_type"); // select_type, questions, result
  const [decisionLabel, setDecisionLabel] = useState("");
  const [isSudden, setIsSudden] = useState(false);
      ...
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, width: "100%", maxWidth: 320 }}>
          {DECISION_TYPES.map(type => (
            ...
            >
              <span style={{ flexShrink: 0, display: "flex", alignItems: "center" }}>{type.icon}</span>
  ...
  // PHASE 2: The 1-Tap Circuit Breaker
  if (phase === "questions") {
    return (
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
        ...
        <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 26, fontWeight: 500, color: "#F1F5F9", textAlign: "center", marginBottom: 36, maxWidth: 340, lineHeight: 1.4 }}>
          Did you plan on making this decision when you woke up today?
        </h2>

        <div style={{ display: "flex", flexDirection: "column", gap: 14, width: "100%", maxWidth: 320 }}>
          <button
            onClick={() => { setIsSudden(false); setPhase("result"); }}
            style={{
              padding: "22px 24px",
              background: "#0A2E1A",
              border: "2px solid #4ADE8040",
          ...
          >
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 18, color: "#4ADE80", fontWeight: 600 }}>Yes, I've been planning this.</span>
          </button>
          <button
            onClick={() => { setIsSudden(true); setPhase("result"); }}
            style={{
              padding: "22px 24px",
              background: "#2E0A0A",
              border: "2px solid #F8717140",
          ...
          >
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 18, color: "#F87171", fontWeight: 600 }}>No, this is a sudden reaction.</span>
          </button>
        </div>

        <button onClick={() => setPhase("select_type")} style={{ ...backBtnStyle, marginTop: 40 }}>← Back</button>
      </div>
    );
  }

  // PHASE 3: Permission Output
  if (phase === "result") {
    const safe = !isSudden && mode !== "survival";

    return (
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
        {safe ? (
          <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#4ADE80" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 20 }}><circle cx="12" cy="12" r="10" /><polyline points="9 12 11 14 15 10" /></svg>
        ) : (
          <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#FBBF24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 20 }}><circle cx="12" cy="12" r="10" /><line x1="8" y1="12" x2="16" y2="12" /></svg>
        )}
        ...
        <button
          onClick={() => {
            onLog({ type: "decision", item: decisionLabel, decision: safe ? "go" : "stop", flags: isSudden ? 1 : 0 });
            onBack();
          }}
          style={primaryBtn}
        >
...
const SPEND_CATEGORIES = [
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" /><line x1="12" y1="18" x2="12" y2="18.01" /></svg>, label: "Tech" },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" /><line x1="3" y1="6" x2="21" y2="6" /><path d="M16 10a4 4 0 0 1-8 0" /></svg>, label: "Clothes" },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1" /><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z" /><line x1="6" y1="1" x2="6" y2="4" /><line x1="10" y1="1" x2="10" y2="4" /><line x1="14" y1="1" x2="14" y2="4" /></svg>, label: "Food/Drink" },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg>, label: "Hobby" },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" /></svg>, label: "Care" },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7" rx="1" /><rect x="14" y="3" width="7" height="7" rx="1" /><rect x="14" y="14" width="7" height="7" rx="1" /><rect x="3" y="14" width="7" height="7" rx="1" /></svg>, label: "Random" },
];
...
function SpendCheck({ mode, onBack, onWait, onBuyNow }) {
  ...
  if (result === "waiting") {
    return (
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
        <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#6366F1" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 20 }}><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>
  ...
  if (result === "bought") {
    return (
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
        <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#FBBF24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 20 }}><polyline points="20 6 9 17 4 12" /></svg>
    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
        ...
        {shouldWarn && (
          <div style={{ background: "#2E2A0A", border: "1px solid #FBBF2440", borderRadius: 12, padding: "12px 16px", marginBottom: 24, maxWidth: 340 }}>
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#FBBF24", margin: 0, textAlign: "center" }}>
              {mode === "survival" ? "Survival mode — strongly recommend waiting." : "$" + amt.toLocaleString() + " is a big purchase. Give yourself time."}
            </p>
          </div>
        )}
        <div style={{ display: "flex", flexDirection: "column", gap: 12, width: "100%", maxWidth: 300, marginBottom: 20 }}>
          ...
          >
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 18, fontWeight: 600, color: "#6366F1", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6366F1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg> Wait {suggestedWait} hours</span>
...
function QuickLog({ onBack, onLog }) {
  ...
  if (done) {
    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
        {skipped ? (
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#4ADE80" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 16 }}><path d="M12 3L4 7v5c0 5.25 3.4 10.15 8 11.5 4.6-1.35 8-6.25 8-11.5V7l-8-4z" /><polyline points="9 12 11 14 15 10" /></svg>
        ) : (
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#FBBF24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 16 }}><polyline points="20 6 9 17 4 12" /></svg>
        )}
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#FBBF24" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 16 }}><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" /></svg>
...
function QuickReset({ onBack }) {
  return (
    <div style={{ minHeight: "100vh", background: "#020617", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ display: "flex", flexDirection: "column", gap: 40, width: "100%", maxWidth: 320, marginBottom: 60 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}><path d="M12 22c-4 0-8-2-8-8V6l8-4 8 4v8c0 6-4 8-8 8z" /><line x1="8" y1="11" x2="16" y2="11" /><line x1="8" y1="15" x2="16" y2="15" /></svg>
          <span style={{ fontFamily: "'Fraunces', serif", fontSize: 22, color: "#E2E8F0", lineHeight: 1.4 }}>Drop your shoulders away from your ears.</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}><circle cx="12" cy="12" r="10" /><path d="M8 14s1.5 2 4 2 4-2 4-2" /><line x1="9" y1="9" x2="9.01" y2="9" /><line x1="15" y1="9" x2="15.01" y2="9" /></svg>
          <span style={{ fontFamily: "'Fraunces', serif", fontSize: 22, color: "#E2E8F0", lineHeight: 1.4 }}>Unclench your jaw.</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}><path d="M9.59 4.59A2 2 0 1 1 11 8H2" /><path d="M12.59 19.41A2 2 0 1 0 14 16H2" /><path d="M17.73 7.27A2.5 2.5 0 1 1 19.5 12H2" /></svg>
          <span style={{ fontFamily: "'Fraunces', serif", fontSize: 22, color: "#E2E8F0", lineHeight: 1.4 }}>Take one slow, deep breath.</span>
        </div>
      </div>

      <button onClick={onBack} style={{ padding: "22px 48px", background: "#6366F1", border: "none", borderRadius: 16, color: "#fff", fontSize: 18, fontFamily: "'DM Sans', sans-serif", fontWeight: 600, cursor: "pointer", width: "100%", maxWidth: 320 }}>
        I'm back →
      </button>
    </div>
  );
...
function TrackRecord({ spendLog, checkins, onBack }) {
  const spendEntries = spendLog.filter(e => e.type === "spend");
  const skipped = spendEntries.filter(e => e.decision === "skip");
  const totalKept = skipped.reduce((s, e) => s + (e.amount || 0), 0);
  const pausedCount = skipped.length;

  const insight = pausedCount > 0
    ? "Waiting is working. You've successfully paused " + pausedCount + " purchase" + (pausedCount === 1 ? "" : "s") + "."
    : "No paused purchases yet. Use the spend check tool and your track record will build up here.";

  return (
    <div style={{ minHeight: "100vh", padding: "32px 20px", maxWidth: 480, margin: "0 auto" }}>
      <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 26, fontWeight: 500, color: "#F1F5F9", marginBottom: 24 }}>Track Record</h2>

      {/* The Wins */}
      <div style={{ display: "flex", gap: 12, marginBottom: 20 }}>
        <div style={{ flex: 1, background: "#0A2E1A", border: "1px solid #4ADE8030", borderRadius: 18, padding: "20px 16px", textAlign: "center" }}>
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, color: "#4ADE80", margin: "0 0 6px", fontWeight: 700, textTransform: "uppercase", letterSpacing: 2 }}>Total Money Kept</p>
          <p style={{ fontFamily: "'Fraunces', serif", fontSize: 32, color: "#4ADE80", margin: 0, fontWeight: 600 }}>${totalKept.toLocaleString()}</p>
        </div>
        <div style={{ flex: 1, background: "#0F172A", border: "1px solid #6366F130", borderRadius: 18, padding: "20px 16px", textAlign: "center" }}>
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, color: "#6366F1", margin: "0 0 6px", fontWeight: 700, textTransform: "uppercase", letterSpacing: 2 }}>Purchases Paused</p>
          <p style={{ fontFamily: "'Fraunces', serif", fontSize: 32, color: "#6366F1", margin: 0, fontWeight: 600 }}>{pausedCount}</p>
        </div>
      </div>

      {/* The Insight */}
      <div style={{ background: "#0F172A", border: "1px solid #1E293B", borderRadius: 14, padding: "14px 18px", marginBottom: 24 }}>
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#94A3B8", margin: 0, lineHeight: 1.6 }}>{insight}</p>
      </div>

      {/* The Ledger */}
      {spendLog.length === 0 ? (
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 15, color: "#475569", textAlign: "center", marginTop: 40 }}>No entries yet. Your choices will show up here.</p>
      ) : (
        <div style={{ background: "#0F172A", borderRadius: 16, padding: "4px 0", overflow: "hidden" }}>
          {(() => {
            const reversed = [...spendLog].reverse();
            return reversed.map((entry, i) => {
              const isDecision = entry.type === "decision";
              const isPositive = isDecision ? entry.decision === "stop" : entry.decision === "skip";
              const icon = isPositive
                ? <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4ADE80" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3L4 7v5c0 5.25 3.4 10.15 8 11.5 4.6-1.35 8-6.25 8-11.5V7l-8-4z" /></svg>
              ...
              const badgeText = isDecision
                ? (entry.decision === "stop" ? "Paused" : "Proceeded")
                : (entry.decision === "skip" ? "Kept the money" : "Bought it");
              const badgeColor = isPositive ? "#4ADE80" : "#64748B";
              const badgeBg = isPositive ? "#0A2E1A" : "#1E293B";
              const isLast = i === reversed.length - 1;

              return (
                <div key={i} style={{ display: "flex", alignItems: "center", padding: "14px 18px", background: "transparent", borderBottom: isLast ? "none" : "1px solid #1E293B" }}>
                  <span style={{ flexShrink: 0, marginRight: 14, display: "flex", alignItems: "center" }}>{icon}</span>
                  <div style={{ flex: 1 }}>
                    ...
                    <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: "#64748B", margin: "4px 0 0" }}>
                      {isDecision ? entry.date : "$" + (entry.amount || 0).toLocaleString() + " · " + entry.date}
                    </p>
                  </div>
                  <div style={{
                    padding: "6px 10px",
      ...
      <button onClick={onBack} style={{ ...backBtnStyle, marginTop: 28, marginBottom: 32 }}>← Back to dashboard</button>
    </div>
  );
}
...
function Settings({ onRedoCheckin, onLogout, onBack }) {
  return (
    <div style={{ minHeight: "100vh", padding: "32px 20px", maxWidth: 480, margin: "0 auto" }}>
      <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 26, fontWeight: 500, color: "#F1F5F9", marginBottom: 8 }}>Settings</h2>
      <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#64748B", marginBottom: 28 }}>Manage your session.</p>
    ...
    <div style={{ background: "#020617", minHeight: "100vh", color: "#F1F5F9" }}>
      ...
      {authChecked && session && dataLoaded && (
        <>
          ...
          {screen === "track-record" && <TrackRecord spendLog={spendLog} checkins={checkins} onBack={() => setScreen("dashboard")} />}
          {screen === "reset" && <QuickReset onBack={() => setScreen("dashboard")} />}
          {screen === "settings" && <Settings onRedoCheckin={() => setScreen("checkin")} onLogout={handleLogout} onBack={() => setScreen("dashboard")} />}
