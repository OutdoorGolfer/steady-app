  ...
  return (
    <div style={{ minHeight: "100vh", padding: "30px 20px 24px", maxWidth: 480, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: 10 }}>
        ...
        <button onClick={() => setScreen("spend")} style={primaryCardStyle}>
      ...
      <section style={{ marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <button onClick={() => setScreen("patterns")} style={secondaryCard}>
            <span style={{ fontSize: 22, flexShrink: 0 }}>📈</span>
            <div style={{ flex: 1 }}>
              <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 16, fontWeight: 700, color: "#F8FAFC", margin: 0 }}>My Patterns</p>
              <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 13, color: "#94A3B8", margin: "4px 0 0" }}>
