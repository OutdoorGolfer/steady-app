      ...
      <section style={{ marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <button onClick={() => setScreen("history")} style={secondaryCard}>
            ...
            <div style={{ flex: 1 }}>
              <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 16, fontWeight: 700, color: "#F8FAFC", margin: 0 }}>What you decided</p>
          ...
          <button onClick={() => setScreen("patterns")} style={secondaryCard}>
            <span style={{ fontSize: 22, flexShrink: 0 }}>📈</span>
            <div style={{ flex: 1 }}>
              <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 16, fontWeight: 700, color: "#F8FAFC", margin: 0 }}>Your habits</p>
              <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 13, color: "#94A3B8", margin: "4px 0 0" }}>
                See what the app is learning about you
              </p>
            </div>
            <span style={{ color: "#51627D", fontSize: 20 }}>›</span>
          </button>
          ...
          <button onClick={() => setScreen("transition")} style={secondaryCard}>
            <span style={{ fontSize: 22, flexShrink: 0 }}>🔄</span>
            <div style={{ flex: 1 }}>
              <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 16, fontWeight: 700, color: "#F8FAFC", margin: 0 }}>I need to reset</p>
              <p style={{ fontFamily: "’DM Sans’, sans-serif", fontSize: 13, color: "#94A3B8", margin: "4px 0 0" }}>
